...
void storeu(core_t *core)
{
    ...
    u64 adresse = core->U[instruction.register_1] + core->U[instruction.register_2] + instruction.offset;
    ...
    memcpy(&core->memory[adresse], &core->U[instruction.register_3], sizeof(u64));
